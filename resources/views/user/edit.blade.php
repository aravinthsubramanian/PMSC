                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="name" type="text" value="{{ $user->name }}" placeholder="Enter Admin Name">
                                        </div>
                                        @error('name')
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="mobile" type="text" value="{{ $user->mobile }}" placeholder="Mobile">
                                        </div>
                                        @error('mobile')
                                            <p class='text-danger'>{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="email" type="text" value="{{ $user->email }}" placeholder="Email" disabled>
                                        </div>
                                        @error('email')
                                            <p class='text-danger'>{{ $message }}</p>
                                        @enderror
