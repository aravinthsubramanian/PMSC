                                                    ...
                                                    <td>
                                                        <div class="table-btns">
                                                            @haspermission('SUBCATEGORY_UPDATE', 'admin')
                                                                <a class="btn edit-btn" href="{{ route('subcategories.edit', $subcategory->id) }}">
                                                                    <i class="feather-edit"></i>
                                                                </a>
                                                            @endhaspermission
                                                            @haspermission('SUBCATEGORY_DELETE', 'admin')
                                                                <a class="btn delete-btn" data-id="{{ $subcategory->id }}" data-bs-toggle="modal" data-bs-target="#exampleModal" href="#">
        ...
        <script>
            $(document).ready(function() {
                $('.delete-btn').click(function() {
                    ...
                    var del = "{{ route('subcategories.destroy', 'subcategoryId') }}";
                    del = del.replace('subcategoryId', subcategoryId);
                    $('#del').attr('action', del);
                });
            });
        </script>
