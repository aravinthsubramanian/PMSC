                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="role" type="text" value="{{ $role->name }}" placeholder="Enter Role Name">
                                        </div>
                                        @error('role')
                                                        ...
                                                        @foreach ($permissions as $permission)
                                                            ...
                                                            <div class="col">
                                                                <div class="form-check">
                                                                    <input class="form-check-input permissions" type="checkbox" value="{{ $permission->id }}" name="permission[]" @if (in_array($permission->id, $rolePermissions)) checked @endif>
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        @foreach ($permissions as $permission)
                                                            ...
                                                            <div class="col">
                                                                <div class="form-check">
                                                                    <input class="form-check-input roles" type="checkbox" value="{{ $permission->id }}" name="permission[]" @if (in_array($permission->id, $rolePermissions)) checked @endif>
                                                                    <label class="form-check-label" for="flexCheckDefault">{{ $permission->name }}</label>
                                                                </div>
                                                            </div>
                                                            @endif
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        @foreach ($permissions as $permission)
                                                            ...
                                                            <div class="col">
                                                                <div class="form-check">
                                                                    <input class="form-check-input users" type="checkbox" value="{{ $permission->id }}" name="permission[]" @if (in_array($permission->id, $rolePermissions)) checked @endif>
                                                                    <label class="form-check-label" for="flexCheckDefault">{{ $permission->name }}</label>
                                                                </div>
                                                            </div>
                                                            @endif
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        @foreach ($permissions as $permission)
                                                            ...
                                                            <div class="col">
                                                                <div class="form-check">
                                                                    <input class="form-check-input admins" type="checkbox" value="{{ $permission->id }}" name="permission[]" @if (in_array($permission->id, $rolePermissions)) checked @endif>
                                                                    <label class="form-check-label" for="flexCheckDefault">{{ $permission->name }}</label>
                                                                </div>
                                                            </div>
                                                            @endif
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        @foreach ($permissions as $permission)
                                                            ...
                                                            <div class="col">
                                                                <div class="form-check">
                                                                    <input class="form-check-input categories" type="checkbox" value="{{ $permission->id }}" name="permission[]" @if (in_array($permission->id, $rolePermissions)) checked @endif>
                                                                    <label class="form-check-label" for="flexCheckDefault">{{ $permission->name }}</label>
                                                                </div>
                                                            </div>
                                                            @endif
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        @foreach ($permissions as $permission)
                                                            ...
                                                            <div class="col">
                                                                <div class="form-check">
                                                                    <input class="form-check-input subcategories" type="checkbox" value="{{ $permission->id }}" name="permission[]" @if (in_array($permission->id, $rolePermissions)) checked @endif>
                                                                    <label class="form-check-label" for="flexCheckDefault">{{ $permission->name }}</label>
                                                                </div>
                                                            </div>
                                                            @endif
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        @foreach ($permissions as $permission)
                                                            ...
                                                            <div class="col">
                                                                <div class="form-check">
                                                                    <input class="form-check-input products" type="checkbox" value="{{ $permission->id }}" name="permission[]" @if (in_array($permission->id, $rolePermissions)) checked @endif>
                                                                    <label class="form-check-label" for="flexCheckDefault">{{ $permission->name }}</label>
                                                                </div>
                                                            </div>
                                                            @endif
